package com.example.bordelmc.login
...
import com.example.bordelmc.navigation.MainNavRoutes
    ...
    Column(
        ...
        LaunchedEffect(key1 = loginViewModel?.userExists) {
            if (loginViewModel?.userExists == true) {
                navController.popBackStack()
                navController.navigate(MainNavRoutes.Home.routes) {
                    popUpTo(MainNavRoutes.Home.routes)
